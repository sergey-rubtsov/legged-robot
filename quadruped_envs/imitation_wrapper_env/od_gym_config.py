...
class SimulationParameters(object):
  ...
  sim_time_step_s = attr.ib(type=float, default=0.005)  # world
  ...
  camera_distance = attr.ib(type=float, default=1.2)
  camera_yaw = attr.ib(type=float, default=0)
  camera_pitch = attr.ib(type=float, default=0)
  render_width = attr.ib(type=int, default=480)  # 480 x 360; 1024 x 800
  render_height = attr.ib(type=int, default=360)
  egl_rendering = attr.ib(type=bool, default=False)
  motor_control_mode = attr.ib(type=int, default=robot_config.MotorControlMode.TORQUE)
